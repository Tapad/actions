...
class SalesforceOauthHelper {
    ...
    oauthUrl(redirectUri, encryptedPayload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const url = new url_1.URL(authorizeUrl);
...
exports.sfdcConnFromRequest = (request, tokens, oauthCreds) => __awaiter(void 0, void 0, void 0, function* () {
    const oauth2 = new jsforce.OAuth2({
...
exports.salesforceLogin = (request) => __awaiter(void 0, void 0, void 0, function* () {
    const sfdcConn = new jsforce.Connection({
